...
/**
 * Testing the upgrade of simulationceis question attempts.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_simulationceis_attempt_upgrader_test extends question_attempt_upgrader_test_base {

    public function test_simulationceis_deferredfeedback_history620() {
        $quiz = (object) array(
            'id' => '203',
            'course' => '2359',
            'name' => 'Quiz 1',
    ...
    public function test_simulationceis_deferredfeedback_history20() {
        $quiz = (object) array(
            'id' => '551',
            'course' => '2828',
            'name' => 'Unit 4 Quiz',
    ...
    public function test_simulationceis_deferredfeedback_history90() {
        $quiz = (object) array(
            'id' => '3',
            'course' => '1095',
    ...
    public function test_simulationceis_adaptive_qsession119() {
        $quiz = (object) array(
            'id' => '6',
            'course' => '3',
            'name' => 'Simply quiz',
    ...
    public function test_simulationceis_adaptive_qsession120() {
        $quiz = (object) array(
            'id' => '6',
            'course' => '3',
            'name' => 'Simply quiz',
 ...
 public function test_simulationceis_adaptive_qsession3() {
        $quiz = (object) array(
            'id' => '1',
            'course' => '2',
            'name' => 'Test Quiz',
