 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_simulationceis_question_test extends UnitTestCase {
    public function test_is_complete_response() {
        $question = test_question_maker::make_question('simulationceis', 'true');
    ...
    public function test_get_question_summary() {
        $tf = test_question_maker::make_question('simulationceis', 'true');
    ...
    public function test_summarise_response() {
        ...
        $this->assertEqual(get_string('false', 'qtype_simulationceis'),
                $tf->summarise_response(array('answer' => '0')));

        $this->assertEqual(get_string('true', 'qtype_simulationceis'),
    ...
    public function test_classify_response() {
        ...
        $this->assertEqual(array(
                $tf->id => new question_classified_response(
                        0, get_string('false', 'qtype_simulationceis'), 0.0)),
                $tf->classify_response(array('answer' => '0')));
        $this->assertEqual(array(
                $tf->id => new question_classified_response(
                        1, get_string('true', 'qtype_simulationceis'), 1.0)),
