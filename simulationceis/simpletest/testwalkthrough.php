...
/**
 * This file contains tests that walks a simulationceis question through various
 * behaviours.
 *
 * @package    qtype
...
/**
 * Walkthrough tests for the simulationceis question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_simulationceis_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_false_right_does_not_show_feedback_when_not_answered() {
        ...
        $tf = test_question_maker::make_question('simulationceis', 'false');
